...
function buildCube() {
    ...
    for (let i = -1; i < 2; i++) {
        for (let k = -1; k < 2; k++) {
            const square = new THREE.Mesh(geometrySquare, materialWhite)
    ...
    for (let i = -1; i < 2; i++) {
        for (let k = -1; k < 2; k++) {
            const square = new THREE.Mesh(geometrySquare, materialYellow)
            square.position.x = i * sideWidth * separation;
            square.position.y = sideWidth * separation * 1.5;
            square.position.z = k * sideWidth * separation;
            square.rotation.x = -Math.PI / 2;
    ...
    for (let j = -1; j < 2; j++) {
        for (let k = -1; k < 2; k++) {
            const square = new THREE.Mesh(geometrySquare, materialOrange)
    ...
    for (let j = -1; j < 2; j++) {
        for (let k = -1; k < 2; k++) {
            const square = new THREE.Mesh(geometrySquare, materialRed)
            square.position.x = sideWidth * separation * 1.5;
            square.position.y = j * sideWidth * separation;
            square.position.z = k * sideWidth * separation;
            square.rotation.x = 0;
    ...
    for (let i = -1; i < 2; i++) {
        for (let j = -1; j < 2; j++) {
            const square = new THREE.Mesh(geometrySquare, materialBlue)
            square.position.x = i * sideWidth * separation;
            square.position.y = j * sideWidth * separation;
